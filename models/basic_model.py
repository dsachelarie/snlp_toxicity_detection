...
from utils import read_data, write_preds, get_tf_prob_weights, read_prob_weights_cached, get_tf_prob_test_weights
import os
...
class BasicModel:
    def __init__(self, mode="debug", preprocessing="glove"):
        ...
        if preprocessing == "glove_tf_prob" and not os.path.isfile("data/cache_prob_weights.csv"):
            weights = get_tf_prob_weights("data/train_2024.csv", cache="data/cache_prob_weights.csv")
            ...
            weights = get_tf_prob_weights("data/train_2024.csv", prob_per_word=prob_per_word)
        ...
        if self.mode == "debug":
            ...
            if preprocessing == "glove_tf_prob":
                weights = get_tf_prob_test_weights("data/test_2024.csv", prob_per_word)
